...
# --- FIX: Add the 'backend' folder to sys.path so Railway can find internal modules ---
...
from cloud_logging_setup import logger
# Load config
load_dotenv()
...
async def startup():
    logger.info("FastAPI service starting", extra={
      "service": "news-bias-backend",
      "version": "2.0.0"
    })
    try:
